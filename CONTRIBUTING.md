...
The conformance harness validates every example in `0.3.0/examples/` against the JSON Schema (draft 2020-12), then runs semantic checks the schema cannot express:
