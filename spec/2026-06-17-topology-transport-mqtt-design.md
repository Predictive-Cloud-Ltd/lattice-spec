...
**v0.1 decision:** keep [`../0.1.0/topology-data-plane.proto`](../0.1.0/topology-data-plane.proto) as the normative wire artifact, but define it as **Sparkplug-aligned**, not a competing semantic layer and not yet a formal Sparkplug profile.
