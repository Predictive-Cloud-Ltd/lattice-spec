// Copy the canonical schema + example from 0.3.0/ into src/generated/ so the
...
copyFileSync(
  resolve(repo, "0.3.0/topology-capability-doc.schema.json"),
  resolve(out, "schema.json"),
);
copyFileSync(
  resolve(repo, "0.3.0/examples/example-site.topology.json"),
